...
tmux new-window -n "$(basename $1)" "cd $1 && tmux split-window -v && PROB=$(basename $1) && tmux resizep -y 30 && tmux selectp -L && nvim 'main_$(basename $1).cpp' -c 'execute \"normal /-1;/\" | normal \"ggnn\" | noh'"
