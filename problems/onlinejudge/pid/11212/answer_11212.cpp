/**
 * https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=841&page=show_problem&problem=2153
 * only cut consequtive segments, and don't paste into consequtive segments
 */
