 ...
 * Accepted Fri 06 Sep 2019 @ 07:19 (PDT)
 *
 */
...
void bfs (const int ci, const int cj)
{
  ...
  {
    // printf("%d, %d:\n", pq.top().i, pq.top().j); for (int i=0; i<a; ++i) { printf("  "); for (int j=0; j<b; ++j) printf("%3d", mat[i][j].val); printf("\n"); }
